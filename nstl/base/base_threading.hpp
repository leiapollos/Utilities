...
UTILITIES_SHARED_API void spmd_destroy_group(SPMDGroup* group);
...
UTILITIES_SHARED_API U64 spmd_lane_id();
UTILITIES_SHARED_API U64 spmd_lane_count();

UTILITIES_SHARED_API RangeU64 spmd_split_range_(U64 totalCount, U64 laneId, U64 laneCount);
...
UTILITIES_SHARED_API SPMDGroup* spmd_dispatch_(JobSystem* jobSystem, Arena* arena, const SPMDDispatchOptions& options);
