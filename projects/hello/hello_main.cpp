// Hello project TU root: engine unity first (statics flow engine ->
// project), then the product.
#include "engine/engine_include.hpp"
#include "engine/engine_include.cpp"

#include "projects/hello/hello_state.hpp"
...
#include "projects/hello/hello.cpp"
